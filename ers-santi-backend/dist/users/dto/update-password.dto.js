...
], UpdatePasswordDto.prototype, "contrasenia_actual", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(10, { message: 'La nueva contraseña debe tener al menos 10 caracteres.' }),
    (0, class_validator_1.Matches)(/[!@#$%^&*(),.?":{}|<>]/, {
        message: 'La nueva contraseña debe contener al menos un símbolo especial.',
    }),
    __metadata("design:type", String)
], UpdatePasswordDto.prototype, "nueva_contrasenia", void 0);
